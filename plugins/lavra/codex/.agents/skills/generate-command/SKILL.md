...
<objective>
Create a new slash command in `.agents/skills/` for the requested task, following Claude Code command conventions and best practices.
</objective>
...
- TaskCreate/TaskUpdate/TaskList - track progress with task lists
...
- **Reference CLAUDE.md or AGENTS.md** patterns and conventions
...
3. Implement
   ...
   - Ensure code follows CLAUDE.md or AGENTS.md conventions
...
<success_criteria>
- Command file created at `.agents/skills/[name].md`
