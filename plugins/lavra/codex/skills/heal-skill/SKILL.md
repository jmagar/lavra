---
name: heal-skill
description: Fix broken skill documentation -- correct SKILL.md instructions, update stale API references, and repair skill execution errors.
---
...
Focus on detecting what went wrong during skill execution.
