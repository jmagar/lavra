---
name: changelog
description: Generate engaging changelogs summarizing recent merges, PRs, features, and bug fixes with contributor credit. Accepts daily/weekly periods.
---
...
Review the changelog using the EVERY_WRITE_STYLE.md file and go one by one to make sure you are following the style guide. Use multiple agents, run in parallel to make it faster.

Remember, your final output should only include the content within the changelog tags. Do not include any of your thought process or the original data in the output.
